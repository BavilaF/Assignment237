...
<?php require("movieNav.php"); ?>
    ...
    <div class="container">
      ...
      <form action="Assignment1Php.php" method="GET" class="form-horizontal" novalidate>
        ...
        <div class="form-group required">
          <label for="FormControlInput2">Director's Name</label>
        ...
        <label class="radio-inline">
          <input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="1 stars" required> 1
        </label>
        <label class="radio-inline">
          <input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="2 stars" required> 2
        </label>
        <label class="radio-inline">
          <input type="radio" name="inlineRadioOptions" id="inlineRadio3" value="3 stars" required> 3
        </label>
        <label class="radio-inline">
          <input type="radio" name="inlineRadioOptions" id="inlineRadio4" value="4 stars" required> 4
        </label>
        <label class="radio-inline">
          <input type="radio" name="inlineRadioOptions" id="inlineRadio5" value="5 Stars" required> 5
        </label>
